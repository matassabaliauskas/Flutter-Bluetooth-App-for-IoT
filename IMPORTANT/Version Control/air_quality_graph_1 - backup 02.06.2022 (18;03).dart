...
class _LineChartWidget_1_State extends State<LineChartWidget_1> {
  ...
  Widget build(BuildContext context) {
    ...
    child: SizedBox(
      width: (globals.airSensorValue1Counter <= 10) ? ((MediaQuery.of(context).size.width)-30) : (((MediaQuery.of(context).size.width)-30) + globals.airSensorValue1Counter*20),
      ...
      LineChartData(
        minX: 0,
        maxX: double.parse((globals.airSensorValue1Counter-1).toString()),
        ...
        lineBarsData: [
          LineChartBarData(
            spots: [
            for(int counter = 0; counter< globals.airSensorValue1Counter; counter++)
            //  const FlSpot(0, 70),
